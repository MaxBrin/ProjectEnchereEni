...
<body>
	...
	<form action="Connexion" method="post">
		...
		<label for="identifiant">Identifiant</label> <input type="text"
			name="identifiant" id="identifiant"> <label for="motDePasse">Mot
			de passe</label> <input type="password" name="motDePasse" id="motDePasse">
		...
		<input type="checkbox" name="seSouvenir"> <a href="">Mot
			de passe oublié</a>
