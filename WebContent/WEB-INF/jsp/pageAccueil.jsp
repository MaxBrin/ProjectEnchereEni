...
<html>
	<head>
		...
		<link
			...
			rel="stylesheet">
		<link
			href="https://fonts.googleapis.com/css2?family=Architects+Daughter&display=swap" rel="stylesheet">
						...
						<div class="card-body">
							...
							<h5 class="card-title">
								<c:choose>
									...
									<c:otherwise>
										<a href="${pageContext.request.contextPath }/DetailVente?idArticle=${article.noArticle}">${article.nomArticle }</a>
									</c:otherwise>
								</c:choose>
